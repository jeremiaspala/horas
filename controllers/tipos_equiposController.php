...
class tipos_equiposController{
    
    public function index(){
        Utils::isIdentity();
        Utils::isAdmin();
        require_once 'views/layout/header.php';
        $cat = new Tipos_Equipos();
        $categoria = $cat->getAll();
        require_once 'views/tipos_equipos/index.php';
    ...
    public function nuevo(){
        ...
        Utils::isAdmin();
        require_once 'views/layout/header.php';
        require_once 'views/tipos_equipos/nuevo.php';
        require_once 'views/layout/footer.php';
    }
    ...
    public function salvar(){
        ...
        header("Location: ".base_url."tipos_equipos/index");
    }
    //Editar
    public function editar(){
        ...
        if(isset($_REQUEST['id'])){
            ...
            endforeach;
            require_once 'views/tipos_equipos/editar.php';
            require_once 'views/layout/footer.php';
        }
    }
    //Actualizar
