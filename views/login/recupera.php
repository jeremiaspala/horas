            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Recuperación de Password</h1>
                        <p class="signup-link recovery">Ingresé su email, le enviaremos instrucciones de recuperación!</p>
                        <form class="text-left" action="<?=base_url?>login/enviar">
                            <div class="form">
