                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                                <div style="display: box; text-align: right; padding: 5px 5px 5px 5px;">
                                    <button class="btn btn-success mb-2 mr-2 btn-rounded" onclick="window.location.href='<?=base_url?>empresas/nuevo'">Nuevo <svg> <b>+</b> </svg></button>
                                </div>      
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="cat<?=$r['id']?>">
                                            ...
                                            <td class="text-center">
                                                <a href="<?=base_url?>empresas/agregar&id=<?=$r['id']?>">+ Empleados</a> |<a href="<?=base_url?>empresas/editar&id=<?=$r['id']?>">Editar</a> | <a onclick="eliminar(<?=$r['id']?>);">Eliminar</a>
                                            </td>
                                        </tr>
                                        <?php                               
                                        endforeach;
...
function eliminar(id){
    ...
    if(a === true){
        $.ajax({
		type: "post",
		url: "<?=base_url?>empresas/eliminar&id="+id,
