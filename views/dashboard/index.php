                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Control de Horas Dashboard</h3>
                    </div>
                </div>
                ...
                <div class="row layout-top-spacing">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-chart-one">
                            <div class="widget-heading">
                                <h5 class="">Horas y Pagos por mes</h5>
                                <ul class="tabs tab-pills">
                                    <li><a href="javascript:void(0);" id="tb_1" class="tabmenu">Por Mes</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-12 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-table-one">
                            <div class="widget-heading">
                                <h5 class="">Horas No Liquidadas</h5>
                            </div>
                                    ...
                                    <div class="t-item">
                                        <div class="t-company-name">
                                            ...
                                            <div class="t-name">
                                                ...
                                                <p class="meta-date">Programación</p>
                                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        ...
                        <div class="widget widget-activity-four">
                            ...
                            <div class="widget-heading">
                                <h5 class="">Últimas Horas Cargadas</h5>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        ...
                        <div class="widget widget-account-invoice-one">
                            ...
                            <div class="widget-heading">
                                <h5 class="">Pagos Realizados este mes</h5>
                            </div>
