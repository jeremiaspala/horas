                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                                <div style="display: box; text-align: right; padding: 5px 5px 5px 5px;">
                                    <button class="btn btn-success mb-2 mr-2 btn-rounded" onclick="window.location.href='<?=base_url?>colores/nuevo'">Nuevo <svg> <b>+</b> </svg></button>
                                </div>      
                                ...
                                <table id="default-ordering" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="cat<?=$r['id']?>">
                                            ...
                                            <td><?=$r['color']?></td>
                                            <td><?=$r['precio']?></td>
                                            <td class="text-center"><a href="<?=base_url?>colores/editar&id=<?=$r['id']?>">Editar</a> | <a onclick="eliminarColores(<?=$r['id']?>);">Eliminar</a></td>
                                        </tr>
                                        <?php                               
                                        endforeach;
                                        ?>
...
function eliminarColores(id){
    ...
    if(a === true){
        $.ajax({
		type: "post",
		url: "<?=base_url?>colores/eliminar&id="+id,
