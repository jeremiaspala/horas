<br/><br/><button onclick="window.location.href='<?=base_url?>pedidos/nuevo'" class="btn btn-success mb-2">Cargar Pedido</button>
<br/>
                                            ...
                                            <li class="nav-item">
                                                <div class="nav-link list-actions" id="invoice-<?=$r['id'];?>" data-invoice-id="<?=$r['id'];?>">
                                                    <div class="f-m-body">
                                                        ...
                                                        <div class="f-body">
                                                            <p class="invoice-number">Pedido #<?=$r['id'];?></p>
                                                            <p class="invoice-customer-name"><span>De:</span> <?=$r['nombre']." ".$r['apellidos'];?></p>
                                                            <p class="invoice-generated-date">Fecha: <?=$r['fecha']?></p>
                                                            <p class="invoice-generated-date">Estado: <select>
                            ...
                            <div class="invoice-container">
                                <div class="invoice-inbox">
                                    ...
                                    <div class="inv-not-selected">
                                        <p>Seleccione un pedido para ver el detalle.</p>
                                    </div>
                                            ...
                                            <div class="content-section  animated animatedFadeInUp fadeInUp">
                                                ...
                                                <div class="row inv--head-section">
                                                    ...
                                                    <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                                        <div class="company-info">
                                                            ...
                                                            <h5 class="inv-brand-name">Aluminio del Paraná</h5>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row inv--detail-section">
                                                    ...
                                                    <div class="col-sm-5 align-self-center  text-sm-right order-sm-0 order-1">
                                                        <p class="inv-detail-title">Empresa: <?=$lp['nombre']." ".$lp['apellidos']?></p>
                                                    </div>
                                                    
                                                    <div class="col-sm-7 align-self-center">
                                                        <p class="inv-customer-name"><?=$lp['nombre']." ".$lp['apellidos']?></p>
                                                        <p class="inv-street-addr"><?=$lp['direccion']?>, <?=$lp['localidad']?>, CP<?=$lp['cp']?></p>
                                                    ...
                                                    <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                                        ...
                                                        <p class="inv-created-date"><span class="inv-title">Fecha de solicitud : </span> <span class="inv-date"><?=$lp['fecha']?></span></p>
                                                        <p class="inv-due-date"><span class="inv-title">Fecha de Vencimiento : </span> <span class="inv-date">30 días después de pedido</span></p>
                                                    </div>
                                                </div>
                                                            ...
                                                            <table class="table">
                                                                <thead class="">
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-right" scope="col">KG/MT</th>
                                                                        <th class="text-right" scope="col">KG/MT Reales</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <?php 
                                                                    $li = new Pedidos();
                                                                    $linea = $li->getAllLineas($lp['id']);
                                                                    $total = 0;
                                                                    foreach ($linea as $l):
                                                                    ?>
                                                                    <tr id="lp<?=$l['id']?>">
                                                                        <td><img src="<?=base_url?>uploads/images/<?=$l['imagen']?>" width="60"></td>
                                                                        <td><?=$l['numero']?></td>
                                                                        <td><?=$l['color']?></td>
                                                                        <td class="text-right"><?=$l['unidades']?></td>
                                                                        <td class="text-right"><?=$l['kgmt']?></td>
                                                                        <td class="text-right"><?=$l['kgmt']*$l['unidades']?><?php $total = $total + ($l['unidades']*$l['precio']);?></td>
                                                                    </tr>                                                                   
                                                                    <?php
                                                                    endforeach;
                                                                    ?>
                                                    ...
                                                    <div class="col-sm-7 col-12 order-sm-1 order-0">
                                                        <div class="inv--total-amounts text-sm-right">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8 col-7">
                                                                    <p class=" discount-rate">Peso Real : <span class="discount-percentage">KG</span> </p>
                                                                </div>
                                                                <div class="col-sm-4 col-5">
                                                                    <p class=""><input type="text" value="" name="descuento" id="descuento" placeholder="KG"></p>
                                                                </div>
                                                                <div class="col-sm-8 col-7 grand-total-title">
                                                                    <h4 class="">Total : </h4>
                                                                </div>
                                                                <div class="col-sm-4 col-5 grand-total-amount">
                                                                    <h4 class=""><input type="text" value="" name="total" placeholder="$"></h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
